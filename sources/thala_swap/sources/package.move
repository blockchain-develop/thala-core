...
module thalaswap::package {
    ...
    //                                                                        //
    const DEPLOYER_ADDRESS: address = @thalaswap_deployer;                 //
    const RESOURCE_ACCOUNT_SEED: vector<u8> = b"thalaswap";                //
    const RESOURCE_ACCOUNT_ADDRESS: address = @thalaswap;                  //
    //                                                                        //
    // Modules that can interface with the resource signer                    //
    friend thalaswap::fees;                                                //                                           
    friend thalaswap::base_pool;                                           //
    ...
    fun publish_package_unauthorized_err(thalaswap: &signer) acquires ResourceSignerCapability {
