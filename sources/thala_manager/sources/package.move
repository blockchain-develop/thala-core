...
module thala_manager::package {
    ...
    //                                                                        //
    const DEPLOYER_ADDRESS: address = @thala_manager_deployer;                //
    const RESOURCE_ACCOUNT_SEED: vector<u8> = b"thala_manager";               //
    const RESOURCE_ACCOUNT_ADDRESS: address = @thala_manager;                 //
    //                                                                        //
    // Modules that can interface with the resource signer                    //
    friend thala_manager::manager;                                            //
    //                                                                        //
    //                                                                        //
    // *************************************************************************
    ...
    ///
    /// ***NOTE***: Since this resource itself is the `ThalaManager`, we mark the manager as a friend and proxy calls
